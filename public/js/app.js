...
__webpack_require__(/*! ./dropdowns */ "./resources/js/dropdowns.js");
...
window.addEventListener("DOMContentLoaded", function () {
  var dropdowns = document.querySelectorAll(".form-select[data-bs-toggle='dropdown']");
  var actionButtons = document.querySelectorAll(".dropdown-item[data-dd-action]");

  function updateSelectText(el, dropdownMenuCheckboxes) {
    var text = [];
    dropdownMenuCheckboxes.forEach(function (input) {
      if (input.checked) {
  ...
  actionButtons.forEach(function (button) {
    ...
    var dropDown = button.closest(".dropdown-menu");
...
/******/ 	__webpack_require__.O(undefined, ["css/app","css/pass_club"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app","css/pass_club"], () => (__webpack_require__("./resources/sass/app.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app","css/pass_club"], () => (__webpack_require__("./resources/sass/pass_club.scss")))
